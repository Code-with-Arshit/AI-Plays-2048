...
from game_functions import initialize_game, move_down, move_left, move_right,\
                            move_up, add_new_tile, check_for_win, random_move


def ai_move(board, searches_per_move, search_lenght):
    ...
    for first_index in range(4):
        ...
        for later_moves in range(searches_per_move):
            ...
            while is_valid and move_number < search_lenght:
